...
$searchbook = function(){
  ...
  "&startIndex="+startIndex, function(searchResponse){
    ...
    searchdata +=  "<h2 id='title'>{{title}}</h2>";     
    searchdata += "<br>";
	  searchdata += "<p><img id='img' src=' {{smallThumbnail}}'></p>";
    searchdata += "</div>";
...
$baileyShelf=function(){
    $.get("https://www.googleapis.com/books/v1/users/100449795462524380304/
    bookshelves/1001/volumes?startIndex="+startIndex1, function(searchResponse){
   console.log(searchResponse);
